...
<html lang="en">
<head>
	<title>Coloured Forms Widget Flat Responsive Widget Template :: w3layouts</title>
					...
					<div class="w3_agile_main_left_grid_w3_agileits">
						...
						<form action="#" method="post" novalidate="" id="userform">
							...
							<div class="form-group">
								<label>Name</label><br>
								<input type="text" name="name" placeholder="Name" required="" value="<?php if(isset($name)){ echo $name;} ?>">
							</div><div id="error"><?php if(isset($errName)){echo "<br> $errName <br> <br>";}  ?></div>
